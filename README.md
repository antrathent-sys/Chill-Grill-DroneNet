...
**Heading rate at lean.** The yaw rate fed to the heading filter and the yaw damper is the angular velocity about the *thrust axis* (projected from Sable's world-frame vector using the gimbal's gravity vector and the heading), not about world vertical: at 70° of lean world-vertical is 0.94 roll / 0.34 yaw, and integrating that swung the heading estimate ±25° at 117 b/s, rotating the pitch/roll split under the attitude loop until it tumbled (2026-09-10).
